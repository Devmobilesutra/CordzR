...
public class ActivityRejectedStatus extends AppCompatActivity implements MilkLtrsObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rejected_status);
        context = this;
        registerObservers();
    ...
    public void initComponantListner() {
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View v1 = img_filter;
                PopupMenu popup = new PopupMenu(ActivityRejectedStatus.this, v1);
    ...
    public void bindData() {
        ...
        orderStatusList = TABLE_RETAILER_ORDER_MASTER.getOrderStatusList_new("3");
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos != RecyclerView.NO_POSITION) {
                            ...
                            Intent intent = new Intent(ActivityRejectedStatus.this, ActivityItemDetails.class);
