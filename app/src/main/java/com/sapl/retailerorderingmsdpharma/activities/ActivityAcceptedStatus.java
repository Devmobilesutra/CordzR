...
//activity to show the list of orders which are accepted by distributor
public class ActivityAcceptedStatus extends AppCompatActivity implements MilkLtrsObserver {
    ...
    List<OrderReviewModel> orderStatusList1 = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accepted_status);
        context = ActivityAcceptedStatus.this;
        registerObservers();
    ...
    public void initComponantListner() {
        ...
        img_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View v1 = img_filter;
                PopupMenu popup = new PopupMenu(ActivityAcceptedStatus.this, v1);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (item.toString().equals(getResources().getString(R.string.shop))) {
                           // Toast.makeText(getApplicationContext(), "U SELECTES " + item.toString(), Toast.LENGTH_LONG).show();
                            ...
                            orderStatusList = TABLE_RETAILER_ORDER_MASTER.getStatusListAsPerShop("2");
                        ...
                        if (item.toString().equals(getResources().getString(R.string.calender))) {
                           // Toast.makeText(getApplicationContext(), "U SELECTES " + item.toString(), Toast.LENGTH_LONG).show();
                            orderStatusList = TABLE_RETAILER_ORDER_MASTER.getStatusListAsPerCalender("2");
                            setSelectedData();

                        }
                        if (item.toString().equals(getResources().getString(R.string.shop_calender))) {
                           // Toast.makeText(getApplicationContext(), "U SELECTES " + item.toString(), Toast.LENGTH_LONG).show();
                            orderStatusList = TABLE_RETAILER_ORDER_MASTER.getStatusListAsPerShopAndCalender("2");
                            setSelectedData();
    ...
    public void bindData() {
        ...
        orderStatusList = TABLE_RETAILER_ORDER_MASTER.getOrderStatusList_new("2");
      //  orderStatusList1=TABLE_ORDER_DETAILS.getOrderStatusList1("2");
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos != RecyclerView.NO_POSITION) {
                            ...
                            Intent intent = new Intent(ActivityAcceptedStatus.this, ActivityItemDetailsNew.class);
